...
if __name__ == "__main__":
    ...
    MQTTClient = AWSIoTMQTTClient("RPI_Thing")
    MQTTClient.configureEndpoint("a10xe211sh9vz6-ats.iot.us-east-1.amazonaws.com", 8883)
    MQTTClient.configureCredentials("/home/pi/Downloads/Embedded-Interface-Design/Project_3/certs/Amazon_Root_CA_1.pem", \
                                    "/home/pi/Downloads/Embedded-Interface-Design/Project_3/certs/2a768336b6-private.pem.key",\
                                    "/home/pi/Downloads/Embedded-Interface-Design/Project_3/certs/2a768336b6-certificate.pem.crt")
    ...
    MQTTClient.connect()
    #payload = '{"name": "Vatsal"}'
    #MQTTClient.publish("demo/1","vatsal",0)
    
    
    """Database initialization"""
    db = MySQLdb.connect(host= "localhost", user= "vatsal", passwd="12345", db= "example")
    cur = db.cursor()
    db1 = MySQLdb.connect(host= "localhost", user= "vatsal", passwd="12345", db= "example")
    curs = db1.cursor()
